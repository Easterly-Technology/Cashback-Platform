    ...
    <div className="grid min-h-[calc(100vh-8rem)] items-center py-6">
      <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="hidden lg:flex lg:flex-col lg:justify-center">
          <span className="material-chip w-fit">Admin Access</span>
          <h1 className="material-title mt-5 max-w-lg text-slate-950">
            Review platform health, approvals, and audit activity without losing your place.
          </h1>
        ...
        <div className="material-card p-6 sm:p-8">
          <h1 className="text-3xl font-bold tracking-tight text-slate-950">Admin Portal</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="admin@cashback.dev"
                autoComplete="email"
                required
              />
            </div>
