    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-6">
          ...
          <div className="material-card p-5">
            <h2 className="text-lg font-semibold text-slate-950">Checkout Summary</h2>
            <div className="mt-4 rounded-2xl border border-slate-200 px-4 py-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                This sale was captured through the amount-only merchant QR flow. No
                product-level line items are stored for the transaction record.
              </p>
            </div>
          </div>
        </div>
