          ...
          <div className="grid gap-3">
            <div className="merchant-sidebar-card p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-emerald-50/80">
                Build a basket, generate a customer QR, and keep the checkout line moving during peak windows.
              </p>
            </div>
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500">
                {callbackUrl === "/"
                  ? "Continue to your dashboard and live checkout tools."
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-emerald-100 bg-emerald-50/76 px-4 py-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-700">
                Launch QR sales, watch confirmations, and keep the queue moving.
              </p>
            </div>
